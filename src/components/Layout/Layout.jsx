...
const Layout = ({ children, currentView, onViewChange }) => {
    ...
    return (
        <div className="min-h-screen flex flex-col md:flex-row bg-slate-950 text-slate-50">
            ...
            <aside className="w-full md:w-64 bg-slate-900/50 backdrop-blur-xl border-b md:border-b-0 md:border-r border-slate-800 p-2 md:p-4 flex flex-col justify-between sticky top-0 z-50 md:h-screen">
                <div>
                    <div className="flex items-center gap-3 px-2 mb-0 md:mb-8">
